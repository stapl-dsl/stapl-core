...
trait Syntax {
  implicit class Plus[L, R, Out](l: L) {
    def +(r: R)(implicit ev: Addable[L, R, Out]): Value[Out] = BinaryOp("+", Value(l), Value(r), ev.add _)
  ...
  implicit class PlusValue[L, R, Out](l: Value[L]) {
    def +(r: R)(implicit ev: Addable[L, R, Out]): Value[Out] = BinaryOp("+", l, Value(r), ev.add _)
    def +(r: Value[R])(implicit ev: Addable[L, R, Out]): Value[Out] = BinaryOp("+", l, r, ev.add _)
  }
  
  implicit class Minus[L, R, Out](l: L) {
    def -(r: R)(implicit ev: Subtractable[L, R, Out]): Value[Out] = BinaryOp("-", Value(l), Value(r), ev.subtract _)
  ...
  implicit class MinusValue[L, R, Out](l: Value[L]) {
    def -(r: R)(implicit ev: Subtractable[L, R, Out]): Value[Out] = BinaryOp("-", l, Value(r), ev.subtract _)
    def -(r: Value[R])(implicit ev: Subtractable[L, R, Out]): Value[Out] = BinaryOp("-", l, r, ev.subtract _)
  }
  
  implicit class Times[L, R, Out](l: L) {
    def *(r: R)(implicit ev: Multipliable[L, R, Out]): Value[Out] = BinaryOp("*", Value(l), Value(r), ev.multiply _)
  ...
  implicit class TimesValue[L, R, Out](l: Value[L]) {
    def *(r: R)(implicit ev: Multipliable[L, R, Out]): Value[Out] = BinaryOp("*", l, Value(r) , ev.multiply _)
    def *(r: Value[R])(implicit ev: Multipliable[L, R, Out]): Value[Out] = BinaryOp("*", l, r , ev.multiply _)
  }
  
  implicit class Divide[L, R, Out](l: L) {
    def /(r: R)(implicit ev: Divisible[L, R, Out]): Value[Out] = BinaryOp("/", Value(l), Value(r), ev.divide _)
  ...
  implicit class DivideValue[L, R, Out](l: Value[L]) {
    def /(r: R)(implicit ev: Divisible[L, R, Out]): Value[Out] = BinaryOp("/", l, Value(r), ev.divide _)
    def /(r: Value[R])(implicit ev: Divisible[L, R, Out]): Value[Out] = BinaryOp("/", l, r, ev.divide _)
  }
  
  implicit class Contains[L, R](l: L) {
    def in(r: R)(implicit ev: Containable[L, R]): Value[Boolean] = BinaryOp("in", Value(l), Value(r), ev.isContainedIn _)
  ...
  implicit class ContainsValue[L, R](l: Value[L]) {
    def in(r: R)(implicit ev: Containable[L, R]): Value[Boolean] = BinaryOp("in", l, Value(r), ev.isContainedIn _)
  ...
  implicit class IsEqual[L, R](l: L) {
    def ===(r: R)(implicit ev: Equals[L, R]): Value[Boolean] = BinaryOp("===", Value(l), Value(r), ev.areEqual _)
  ...
  implicit class IsEqualValue[L, R](l: Value[L]) {
    def ===(r: R)(implicit ev: Equals[L, R]): Value[Boolean] = BinaryOp("===", l, Value(r) , ev.areEqual _)
    def ===(r: Value[R])(implicit ev: Equals[L, R]): Value[Boolean] = BinaryOp("===", l, r , ev.areEqual _)
  }
  
  implicit class IsGreaterThan[L, R](l: L) {
    def gt(r: R)(implicit ev: Comparable[L, R]): Value[Boolean] = BinaryOp("gt", Value(l), Value(r), ev.greaterThan _)
  ...
  implicit class IsGreaterThanValue[L, R](l: Value[L]) {
    def gt(r: R)(implicit ev: Comparable[L, R]): Value[Boolean] = BinaryOp("gt", l, Value(r), ev.greaterThan _)
  ...
  implicit class ExtCompare[L, R](l: L) {
    ...
    def lt(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lt", Value(l), Value(r), lt_function(c,e))
    def lt(r: Value[R])(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lt", Value(l), r, lt_function(c,e))
    
    def lteq(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lteq", Value(l), Value(r), lteq_function(c,e))
    def lteq(r: Value[R])(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lteq", Value(l), r, lteq_function(c,e))
    
    def gteq(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("gteq", Value(l), Value(r), gteq_function(c,e))
  ...
  implicit class ExtCompareValue[L, R](l: Value[L]) {
    ...
    def lt(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lt", l, Value(r) , lt_function(c,e))
    def lt(r: Value[R])(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lt", l, r , lt_function(c,e))
    
    def lteq(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lteq", l, Value(r), lteq_function(c,e))
    def lteq(r: Value[R])(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("lteq", l, r, lteq_function(c,e))
    
    def gteq(r: R)(implicit c: Comparable[L, R], e: Equals[L, R]): Value[Boolean] = BinaryOp("gteq", l, Value(r), gteq_function(c,e))
